...
Generated for: analyze page structure and extract information
...
class Config:
    ...
    # Project info
    PROJECT_ID = "161bf435-1ec5-4403-88d5-90a3a82f536c"
    PROJECT_NAME = "automation_project"
    TASK_DESCRIPTION = """analyze page structure and extract information"""
